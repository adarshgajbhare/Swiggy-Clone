  ...
  return (
    <div className="body">
      <div className="filter">
        ...
        <button className="filter-btn" onClick={lowRatedRestaurants}>Low Rated Restaurants</button>
        <button className="filter-btn" onClick={allRatedRestaurants}>All Restaurants</button>
      </div>
      <div className="res-container">
        {listOfRestaurant.map((listOfRestaurant) => (
          <RestaurantCard key={listOfRestaurant.data.id} resData={listOfRestaurant} />
        ))}
      </div>
    </div>
  );
